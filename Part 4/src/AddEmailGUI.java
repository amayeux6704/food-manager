 ...
 * @author Shades
 */
public class AddEmailGUI extends javax.swing.JFrame {
    
    private Restaurant r;
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(AddEmailGUI.class.getName());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Please Enter The New Email:");
