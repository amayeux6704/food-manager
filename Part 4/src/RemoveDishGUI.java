 ...
 * @author Shades
 */
public class RemoveDishGUI extends javax.swing.JFrame {
    
    private Menu m;
    private RecipeManager rM;
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(RemoveDishGUI.class.getName());

    /**
     * Creates new form RemoveDishGUI
     */
    public RemoveDishGUI(Menu m, RecipeManager rM) {
        this.m = m;
        this.rM = rM;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Please Enter The Dish ID To Remove:");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("dishData.txt"))){
            ...
            while ((data = reader.readLine()) != null){
                ...
                if (txtData.length == 3){
                    int id = Integer.parseInt(txtData[2]);
                    m.removeDish(id);
                }
            }
        } catch (Exception e){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() ->{
            ...
            new RemoveDishGUI(mInstance, rMInstance).setVisible(true);
        });
    }
