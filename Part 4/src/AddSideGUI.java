 ...
 * @author Shades
 */
public class AddSideGUI extends javax.swing.JFrame {
    
    private Menu m;
    private RecipeManager rM;
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(AddSideGUI.class.getName());

    /**
     * Creates new form AddSideGUI
     */
    public AddSideGUI(Menu m, RecipeManager rM) {
        this.m = m;
        this.rM = rM;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Please Enter The New Side:");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() ->{
            ...
            new AddSideGUI(mInstance, rMInstance).setVisible(true);
        });
    }
